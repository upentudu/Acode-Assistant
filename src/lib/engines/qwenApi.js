...
async function callNvidiaAPI(onProgress) {
    ...
    const url = "https://integrate.api.nvidia.com/v1/chat/completions";const url = "https://integrate.api.nvidia.com/v1/chat/completions";
    ...
    const response = await fetch(url, {
        ...
        body: JSON.stringify({
            model: "qwen/qwen3.5-122b-a10b", // 🔥 SIRF YE LINE CHANGE KANI HAI BAAKI FILES ME 🔥
...
export async function sendToQwen(prompt, onProgress) {
